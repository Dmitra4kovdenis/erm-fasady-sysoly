            ...
            <Container maxWidth="xl">
                <Toolbar disableGutters>
                    ...
                    <Box sx={{ flexGrow: 1, display: { xs: "flex", md: "none" }, ml: 0 }}>
                        ...
                        >
                            {role === "Администратор" && (
                                <MenuItem onClick={handleCloseNavMenu} component={Link} href="/add-order">
                                    Добавить заказ
                                </MenuItem>
                            )}
                            <MenuItem onClick={handleCloseNavMenu} component={Link} href="/order-list">
                                Список заказов
                            </MenuItem>
                            <MenuItem onClick={handleCloseNavMenu} component={Link} href="/kanban">
                                Доска
                            </MenuItem>
                            {role === "Администратор" && (
                                <MenuItem onClick={handleCloseNavMenu} component={Link} href="/reports">
                                    Отчеты
                                </MenuItem>
                            )}
                            {role === "Администратор" && (
                                <MenuItem onClick={handleCloseNavMenu} component={Link} href="/workers">
                                    Команда
                                </MenuItem>
                            )}
                            <MenuItem onClick={handleCloseNavMenu} component={Link} href="/customers">
                                Заказчики
                            </MenuItem>
                        </Menu>
                    </Box>
